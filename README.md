...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-23 00:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5e08c184-d1c7-4620-abc0-8547b603fcbf.git
$ cd 5e08c184-d1c7-4620-abc0-8547b603fcbf
```
